...
import { useAuthStore, DEMO_ACCOUNT, initializeDemoAccount } from '@/lib/auth-store';
    ...
    <div className="auth-page">
      <div className="auth-container">
        ...
        <div className="auth-logo">
          ...
          <h1>Welcome Back!</h1>
          <p>Sign in to your Pikachu TCG account</p>
        </div>
        ...
        <div className="auth-demo-notice">
          ...
          <div>
            ...
            <p>Click below to fill in demo credentials</p>
          </div>
          <button type="button" onClick={fillDemoCredentials} className="auth-demo-btn">
            Use Demo
          </button>
        </div>
        ...
        <div className="auth-social">
          <button type="button" className="auth-social-btn google" disabled={isLoading}>
          ...
          <button type="button" className="auth-social-btn discord" disabled={isLoading}>
