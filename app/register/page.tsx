...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (passwordStrength < 3) {
      setLocalError('Password is too weak. Please meet at least 3 requirements.');
      return;
    }
    ...
    if (success) {
      showSuccessToast('Welcome to Pikachu TCG!', 'Your account has been created successfully');
      router.push('/');
    }
  };
    ...
    <div className="auth-page">
      <div className="auth-container auth-container-register">
        ...
        <div className="auth-logo">
          ...
          <p>Create your Pikachu TCG account</p>
        </div>
